    ...
    <template v-slot:default >
      <thead >
        <tr>
          ...
          <th style="width:14%;" v-for="week in 6" :key="week">
            <td colspan="5" style="width:100%;">{{week}}주차</td>
          </th>
        </tr>
        <tr>
          <th style="width:13%;" v-for="week in 6" :key="week">
...
export default {
    ...
    methods:{
      ...
      this.thisDay = {day : this.days[day], ondisplay:'block', marginLeft:dayRectMarginLeft, marginTop: dayRectMarginTop};
    },
    mouseoutDay(){
    ...
    getProjectTerms () {
        ...
        this.projectTerms = [
         {
           id:1, end_date:'2021-04-09',grp:1,start_date:'2021-03-01',type:2
         }, 
